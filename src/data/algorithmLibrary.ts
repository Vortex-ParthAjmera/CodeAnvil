...
export const ALGORITHM_SECTIONS: AlgorithmSection[] = [
  {
    ...
    items: [
      ...
      item("Four Sum", "four-sum"),
      item("Dutch National Flag (Sort 0s, 1s, 2s)", "dutch-national-flag"),
      item("Moore's Voting Algorithm (Majority Element)", "majority-vote"),
      item("Sliding Window (Fixed Size)", "sliding-window-fixed"),
      item("Sliding Window (Variable Size)", "sliding-window-variable"),
      item("Prefix Sum", "prefix-sum"),
      item("Difference Array", "difference-array"),
      item("Trapping Rain Water", "trapping-rain-water"),
      item("Rotate Array (Cyclic Rotation)", "rotate-array"),
      item("Merge Intervals", "merge-intervals"),
      item("Next Permutation", "next-permutation"),
