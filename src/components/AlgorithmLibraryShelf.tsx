...
export function AlgorithmLibraryShelf({
  ...
  const activeSectionId = useMemo(
    () => (activeExampleId ? findSectionIdForExample(activeExampleId) : undefined),
    [activeExampleId],
  );
  ...
  return (
    ...
    >
      <div className={cn("flex flex-col gap-3", !compact && "mb-4 sm:flex-row sm:items-end sm:justify-between")}>
        {!compact && (
          <div>
